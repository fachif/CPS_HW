...
model PumpSystem4
  ...
  Workshop5.SolarCollector solarCollector
  ...
  ThermostatValve thermostatValve(redeclare package Medium =
...
equation
  ...
  connect(pipe1.port_b, tank.ports[1]) annotation (Line(points={{-22,-118},{-4,
          -118},{-4,-100}},
                     color={0,127,255}));
  ...
  connect(thermostatValve.port_b, sink.ports[1])
    annotation (Line(points={{60,-120},{90,-120}}, color={0,127,255}));
  connect(thermostatValve.port_a, tank.ports[2]) annotation (Line(points={{40,
          -120},{22,-120},{22,-118},{4,-118},{4,-100}}, color={0,127,255}));
  annotation (Diagram(coordinateSystem(extent={{-140,-140},{120,60}})),  Icon(
        coordinateSystem(extent={{-140,-140},{120,60}})));
end PumpSystem4;
